"""Alembic environment — reads DB URL from app config and discovers all models."""
import os
import sys
...
import app.models  # noqa: E402, F401  — registers all ORM metadata
from app.database import Base  # noqa: E402

# Alembic Config object, provides access to values within alembic.ini
config = context.config

# Override sqlalchemy.url with our app's config (respects .env)
